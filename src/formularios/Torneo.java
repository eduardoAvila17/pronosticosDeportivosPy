...
public class Torneo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        grilla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Denominacion", "Liga", "Periodo", "Estado"
            }
        ) {
    ...
    private void gencod() {
        try {
            ...
            conn.resultado = conn.sentencia.executeQuery("SELECT IFNULL(MAX(id),0)+ 1 AS xxx FROM torneos");
            conn.resultado.next();
    ...
    private void grabar() {
        try {
            ...
            if (bandera.equals("agregar")) {
                ...
                gencod();
                conn.sentencia.executeUpdate("INSERT INTO torneos(id,id_liga,denominacion,periodo,estado)values(" + txtcodigo.getText() + "," + txtCodigoLiga.getText() + ",'" + descripcion.getText() + "'," + txtPeriodo.getText() + "," + estado + ")");
            ...
            if (bandera.equals("editar")) {
                ...
                conn.sentencia.executeUpdate("UPDATE torneos SET periodo = " + txtPeriodo.getText() + " , denominacion='" + descripcion.getText() + "', id_liga=" + txtCodigoLiga.getText() + " ,estado=" + estado + " WHERE id=" + txtcodigo.getText());
                cargar_grilla();
            }
    ...
    private void cargar_grilla() {
        try {
            ...
            ver_conex conn = new ver_conex();
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery("SELECT t.id, t.denominacion, t.periodo ,"
            ...
            while (conn.resultado.next()) {
                Object[] datos = {
                    ...
                    conn.resultado.getString("denominacion"),
                    conn.resultado.getString("liga"),
                    conn.resultado.getString("periodo"),
