...
public class Posicion extends javax.swing.JFrame {
    ...
    private void txtcodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcodigoKeyPressed
        ...
        if (bandera.equals("editar")) {
            if (txtcodigo.getText().equals("") && evt.getKeyChar() == KeyEvent.VK_ENTER)//no trae nada
            {
                ...
                buscador.setTitle("BUSCAR POSICION");
    ...
    private void gencod() {
        try {
            ...
            conn.resultado = conn.sentencia.executeQuery("SELECT IFNULL(MAX(id),0)+ 1 AS xxx FROM posiciones");
            conn.resultado.next();
    ...
    private void grabar() {
        try {
            ...
            if (bandera.equals("agregar")) {
                ...
                gencod();
                conn.sentencia.executeUpdate("INSERT INTO posiciones(id,descripcion,estado)values(" + txtcodigo.getText() + ",'" + descripcion.getText() + "'," + estado + ")");
            ...
            if (bandera.equals("editar")) {
                ...
                conn.sentencia.executeUpdate("UPDATE posiciones SET descripcion='" + descripcion.getText() + "',estado=" + estado + " WHERE id=" + txtcodigo.getText());
                cargar_grilla();
            }
    ...
    private void cargar_grilla() {
        try {
            ...
            ver_conex conn = new ver_conex();
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery("SELECT id, descripcion, case when estado = 1 then 'Activo' else  'inactivo' end as estado from posiciones");
    ...
    private void buscar() {
        try {
            ...
            ver_conex conn = new ver_conex();
            conn.sentencia = conn.conexion.createStatement();
            conn.resultado = conn.sentencia.executeQuery("SELECT p.* "
                    + "\n"
                    + "FROM posiciones p \n"
